...
import { filterPosts, processRecentPosts } from "utils/posts";
...
function PostList({ posts, prefix }: { posts: PostData[]; prefix: string }) {
  return (
            ...
            >
              <div className="w-full h-5 bg-gray-400 group-hover:bg-white transition-all duration-50 ease-in-out">
                <p className="text-xs text-gray-800 font-mono text-center">
                  /{post.metadata.prefix}/{post.metadata.language}
                </p>
              </div>
